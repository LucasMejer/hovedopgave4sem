...
<template>
    <div class="smallindexcardsection">
        <div class="smallindexcard" aria-label="Link to sales guides">
        ...
        <div class="smallindexcard" aria-label="Link to campaign materal">
            <div class="image-container">
        ...
        <div class="smallindexcard" aria-label="Link to videos">
            <div class="image-container">
        ...
        <div class="smallindexcard" aria-label="Link to POS-materials">
            <div class="image-container">
